...
import static com.leecoder.halo.model.support.HaloConst.HALO_VERSION;
...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("com.leecoder.halo.content.api",
                "com.leecoder.halo.controller.content.api",
                "/api/content/**")
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("com.leecoder.halo.admin",
                "com.leecoder.halo.controller.admin",
                "/api/admin/**")
