package com.leecoder.halo.cache.lock;
...
import com.leecoder.halo.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(com.leecoder.halo.cache.lock.CacheLock)")
